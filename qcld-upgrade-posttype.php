...
{
	global $wpdb;
	$updatePageLink = admin_url( 'edit.php?post_type=qcpx_portfolio&page=qcpx-options-page' );
...
function qcpx_register_pt_update_menu() {
    add_submenu_page(
        ...
        __( 'Getting Started', 'qcpx-portfolio' ),
        __( 'Getting Started', 'qcpx-portfolio' ),
        'manage_options',
        'edit.php?post_type=qcpx_portfolio&page=qcpx-options-page',
...
function qcpx_portfolio_item_update_post_type() { 
    ...
    <div class="wrap">
        ...
        <div>
        	...
        	<form action="<?php echo admin_url( 'edit.php?post_type=qcpx_portfolio&page=qcpx-options-page' ); ?>" method="POST">
