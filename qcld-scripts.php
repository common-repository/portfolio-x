...
function qcld_portfolio_admin_enque_script()
{
	...
	if( $screen->id == 'portfolio-x' ) {
		...
		wp_enqueue_style('jquery-carousel', plugins_url('css/owl.carousel.min.css', __FILE__));
		wp_enqueue_style('jquery-default', plugins_url('css/owl.theme.default.css', __FILE__));
		wp_enqueue_script('jquery-carouseljs', plugins_url('js/owl.carousel.min.js', __FILE__));
