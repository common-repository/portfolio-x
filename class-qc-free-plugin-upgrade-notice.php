...
$instance_proftx = new QcPluginUpgradeToProNotice();
...
{ 
	...
	$instance_proftx->upgrade_link = "https://www.quantumcloud.com/products/portfolio-x/";
	// $instance_proftx->link_color = "#FCB21";
	// $instance_proftx->link_text = "Upgrade To Pro";
	// $instance_proftx->link_class = "";
	// $instance_proftx->link_target = "_blank";

	$instance_proftx->plugin_slug = 'portfolio-x'; //Plugin Slug. i.e. Folder Name
	$instance_proftx->plugin_main_file = 'portfolio-x.php'; //Primary file of the pluign
	$instance_proftx->plugin_menu_slug = 'edit.php?post_type=qcpx_portfolio'; //Main Menu Slug

	$instance_proftx->show_with_action_links = true; //show in plugin.php page
	$instance_proftx->show_with_meta_links = true; //show in plugin.php page
	$instance_proftx->show_with_plugin_menu = true; //show inside parent menu of the plugin

	if( $instance_proftx->check_if_plugin_page() )
	{
		$instance_proftx->hook_with_plugin_action_links();
		$instance_proftx->hook_with_plugin_meta_links();
	}
	
	$instance_proftx->hook_with_plugin_submenu();
